...
abstract class BaseSettingsPreferenceFragment<ListenerClass : BaseSettingsPreferenceFragment.Listener> : PreferenceFragmentCompat() {
    ...
    interface Listener {
         ...
         */
        fun onAdblockSettingsChanged(fragment: BaseSettingsPreferenceFragment<*>)
    }
