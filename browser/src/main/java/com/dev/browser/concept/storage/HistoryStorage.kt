...
fun GetVisitTypeByValue(value:Int):VisitType{
    when(value){
        VisitType.NOT_A_VISIT.type-> return VisitType.NOT_A_VISIT
        VisitType.LINK.type-> return VisitType.LINK
        VisitType.TYPED.type-> return VisitType.TYPED
        VisitType.BOOKMARK.type-> return VisitType.BOOKMARK
        VisitType.EMBED.type-> return VisitType.EMBED
        VisitType.REDIRECT_PERMANENT.type-> return VisitType.REDIRECT_PERMANENT
        VisitType.REDIRECT_TEMPORARY.type-> return VisitType.REDIRECT_TEMPORARY
        VisitType.DOWNLOAD.type-> return VisitType.DOWNLOAD
        VisitType.FRAMED_LINK.type-> return VisitType.FRAMED_LINK
        VisitType.RELOAD.type-> return VisitType.RELOAD
        else -> return VisitType.NO_EXIST
    }
}
/**
