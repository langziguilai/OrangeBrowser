...
import com.dev.orangebrowser.databinding.FragmentSettingLibraryBinding
...
class LibrarySettingFragment : BaseFragment(), BackHandler {
    ...
    lateinit var binding: FragmentSettingLibraryBinding
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_setting_library
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentSettingLibraryBinding.bind(super.onCreateView(inflater, container, savedInstanceState))
