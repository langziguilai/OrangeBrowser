...
import com.dev.orangebrowser.databinding.FragmentSettingDownloadManagerBinding
...
class DownloadManagerSettingFragment : BaseFragment(), BackHandler {
    ...
    lateinit var binding: FragmentSettingDownloadManagerBinding
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_setting_download_manager
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentSettingDownloadManagerBinding.bind(super.onCreateView(inflater, container, savedInstanceState))
