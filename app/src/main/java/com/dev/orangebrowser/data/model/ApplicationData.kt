...
fun getBottomMenuActionItems():List<ActionItem>{
    ...
    result.add(ActionItem(nameRes = R.string.forbid_image,iconRes = R.string.ic_forbid_image,id =R.string.ic_forbid_image ))
    result.add(ActionItem(nameRes = R.string.privacy,iconRes = R.string.ic_privacy))
    result.add(ActionItem(nameRes = R.string.vision,iconRes = R.string.ic_normal_screen,id = R.string.ic_normal_screen))
