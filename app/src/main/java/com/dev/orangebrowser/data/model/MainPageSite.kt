...
data class MainPageSite(
    ...
    @ColumnInfo(name = "icon") var icon: String?=null, //icon
    @ColumnInfo(name = "background_color") var backgroundColor: Int?=0xeeeeee,//背景颜色
    @ColumnInfo(name = "text_icon") var textIcon: String?="", //使用文字来代表Icon
    @ColumnInfo(name = "sub_text_icon") var subTextIcon: String?="", //子标题
    @ColumnInfo(name = "text_color") var textColor: Int?=0x111111, //文字颜色
