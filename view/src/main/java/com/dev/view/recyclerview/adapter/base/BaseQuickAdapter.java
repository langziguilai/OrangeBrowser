 ...
 */
package com.dev.view.recyclerview.adapter.base;
...
import com.dev.view.recyclerview.adapter.base.loadmore.SimpleLoadMoreView;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void setEmptyView(View emptyView) {
        ...
        if (mEmptyLayout == null) {
            ...
            final LayoutParams lp = emptyView.getLayoutParams();
            if (lp != null) {
    ...
    /**
     * get the specific view by position,e.g. getViewByPosition(2, R.id.failTextView)
     * <p>
     * bind recyclerView {@link #bindToRecyclerView(RecyclerView)} before use!
     *
     * @see #bindToRecyclerView(RecyclerView)
