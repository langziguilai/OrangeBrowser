package com.dev.view.bottomsheet;
...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                int dx=Math.abs((int)event.getX()-initialX);
                int dy=Math.abs((int)event.getY()-initialY);
                if(2*dx>dy){
                    return false;
                }
            default: // fall out
    ...
    /**
     * Sets a onResult to be notified of bottom sheet events.
     *
     * @param callback The onResult to notify when bottom sheet events occur.
     */
    ...
    private final ViewDragHelper.Callback dragCallback =
            new ViewDragHelper.Callback() {
                ...
                public boolean tryCaptureView(@NonNull View child, int pointerId) {
                    Log.d("dragCallback","tryCaptureView");
                    if (state == STATE_DRAGGING) {
                        return false;
                    }
                ...
                public void onViewPositionChanged(
                    ...
                    Log.d("dragCallback","onViewPositionChanged");
                    dispatchOnSlide(top);
                }

                @Override
                public void onViewDragStateChanged(int state) {
                    Log.d("dragCallback","onViewDragStateChanged");
                ...
                public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
                    Log.d("dragCallback","onViewReleased");
                    int top;
                ...
                public int clampViewPositionVertical(@NonNull View child, int top, int dy) {
                    Log.d("dragCallback","clampViewPositionVertical");
                ...
                public int clampViewPositionHorizontal(@NonNull View child, int left, int dx) {
                    Log.d("dragCallback","clampViewPositionHorizontal");
                    return child.getLeft();
                }

                @Override
                public int getViewVerticalDragRange(@NonNull View child) {
                    Log.d("dragCallback","getViewVerticalDragRange");
                    if (hideable) {
                        return parentHeight;
                    } else {
