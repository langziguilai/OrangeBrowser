...
public class DataBackup {
            ...
            e.onSuccess(true);
                ...
                .subscribe(new SingleObserver<Boolean>() {
                    ...
                    public void onSuccess(Boolean value) {
                        if (value) {
                            Toast.makeText(ReaderApplication.getInstance(), R.string.backup_success, Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(ReaderApplication.getInstance(), R.string.backup_fail, Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    private void upload(String dirPath) {
        ...
        try {
            ...
            new Handler(Looper.getMainLooper())
                    .post(() -> Toast
                            .makeText(ReaderApplication.getInstance(), e.getLocalizedMessage(), Toast.LENGTH_SHORT)
                            .show());
        }
    }
    ...
    private void backupConfig(String file) {
        SharedPreferences pref = ReaderApplication.getConfigPreferences();
