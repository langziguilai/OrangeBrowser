...
public class UpdateManager {
    ...
    public void checkUpdate(boolean showMsg) {
        BaseModelImpl.getInstance().getRetrofitString("https://api.github.com")
                ...
                .get(ReaderApplication.getInstance().getString(R.string.latest_release_api), AnalyzeHeaders.getMap(null))
        ...
        return Observable.create(emitter -> {
            try {
                ...
                if (assets.size() > 0) {
                    ...
                    String thisVersion = ReaderApplication.getVersionName().split("\\s")[0];
