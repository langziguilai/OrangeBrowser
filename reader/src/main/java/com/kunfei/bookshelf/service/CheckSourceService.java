...
public class CheckSourceService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        SharedPreferences preference = ReaderApplication.getConfigPreferences();
    ...
    private void updateNotification(int state, String msg) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, ReaderApplication.channelIdReadAloud)
