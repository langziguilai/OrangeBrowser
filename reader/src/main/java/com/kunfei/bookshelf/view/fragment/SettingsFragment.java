                ...
                .onGranted((requestCode) -> {
                    ...
                    picker.setOnFilePickListener(currentPath -> {
                        if (!currentPath.contains(FileUtils.getSdCardPath())) {
                            ReaderApplication.getInstance().setDownloadPath(null);
                        } else {
                            ReaderApplication.getInstance().setDownloadPath(currentPath);
                        }
                        preference.setSummary(ReaderApplication.downloadPath);
                    });
                    picker.show();
