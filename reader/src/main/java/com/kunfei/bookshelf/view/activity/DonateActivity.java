...
public class DonateActivity extends MBaseActivity {
    ...
    Toolbar toolbar;
    @BindView(R2.id.cv_wx_gzh)
    CardView cvWxGzh;
    @BindView(R2.id.vw_zfb_tz)
    CardView vwZfbTz;
    @BindView(R2.id.vw_zfb_hb)
    CardView vwZfbHb;
    @BindView(R2.id.vw_zfb_rwm)
    CardView vwZfbRwm;
    @BindView(R2.id.vw_wx_rwm)
    CardView vwWxRwm;
    @BindView(R2.id.ll_content)
    LinearLayout llContent;
    @BindView(R2.id.vw_qq_rwm)
    CardView vwQqRwm;
    @BindView(R2.id.vw_zfb_hb_ssm)
    CardView vwZfbHbSsm;
    ...
    public static void getZfbHb(Context context) {
        ...
        try {
            ...
            ReaderApplication.getInstance().upDonateHb();
        }
    }
