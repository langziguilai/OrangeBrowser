...
public class MediaPlayerPop extends FrameLayout {
    ...
    ImageView ivCover;
    @BindView(R2.id.tv_dur_time)
    TextView tvDurTime;
    @BindView(R2.id.player_progress)
    ATESeekBar seekBar;
    @BindView(R2.id.tv_all_time)
    TextView tvAllTime;
    @BindView(R2.id.iv_skip_previous)
    ImageView ivSkipPrevious;
    @BindView(R2.id.fab_play_stop)
    FloatingActionButton fabPlayStop;
    @BindView(R2.id.iv_skip_next)
    ImageView ivSkipNext;
    @BindView(R2.id.iv_timer)
    ImageView ivTimer;
    @BindView(R2.id.iv_chapter)
    ImageView ivChapter;
    @BindView(R2.id.iv_cover_bg)
    ImageView ivCoverBg;
