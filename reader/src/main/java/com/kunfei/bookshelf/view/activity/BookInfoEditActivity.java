...
public class BookInfoEditActivity extends MBaseActivity {
    ...
    ImageView ivCover;
    @BindView(R2.id.tie_book_name)
    EditText tieBookName;
    @BindView(R2.id.til_book_name)
    TextInputLayout tilBookName;
    @BindView(R2.id.tie_book_author)
    EditText tieBookAuthor;
    @BindView(R2.id.til_book_author)
    TextInputLayout tilBookAuthor;
    @BindView(R2.id.tie_cover_url)
    EditText tieCoverUrl;
    @BindView(R2.id.til_cover_url)
    TextInputLayout tilCoverUrl;
    @BindView(R2.id.tv_select_cover)
    TextView tvSelectCover;
    @BindView(R2.id.tv_change_cover)
    TextView tvChangeCover;
    @BindView(R2.id.tv_refresh_cover)
    TextView tvRefreshCover;
    @BindView(R2.id.tie_book_jj)
    EditText tieBookJj;
    @BindView(R2.id.til_book_jj)
