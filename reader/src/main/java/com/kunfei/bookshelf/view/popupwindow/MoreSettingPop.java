...
public class MoreSettingPop extends FrameLayout {
    ...
    View vwBg;
    @BindView(R2.id.sb_click_all_next)
    Switch sbClickAllNext;
    @BindView(R2.id.sb_click)
    Switch sbClick;
    @BindView(R2.id.sb_show_title)
    Switch sbShowTitle;
    @BindView(R2.id.sb_showTimeBattery)
    Switch sbShowTimeBattery;
    @BindView(R2.id.sb_hideStatusBar)
    Switch sbHideStatusBar;
    @BindView(R2.id.ll_hideStatusBar)
    LinearLayout llHideStatusBar;
    @BindView(R2.id.ll_showTimeBattery)
    LinearLayout llShowTimeBattery;
    @BindView(R2.id.sb_hideNavigationBar)
    Switch sbHideNavigationBar;
    @BindView(R2.id.ll_hideNavigationBar)
    LinearLayout llHideNavigationBar;
    @BindView(R2.id.sb_showLine)
    Switch sbShowLine;
    @BindView(R2.id.llScreenTimeOut)
    LinearLayout llScreenTimeOut;
    @BindView(R2.id.tv_screen_time_out)
    TextView tvScreenTimeOut;
    @BindView(R2.id.tvJFConvert)
    TextView tvJFConvert;
    @BindView(R2.id.llJFConvert)
    LinearLayout llJFConvert;
    @BindView(R2.id.tv_screen_direction)
    TextView tvScreenDirection;
    @BindView(R2.id.ll_screen_direction)
    LinearLayout llScreenDirection;
    @BindView(R2.id.sw_volume_next_page)
    Switch swVolumeNextPage;
    @BindView(R2.id.sw_read_aloud_key)
    Switch swReadAloudKey;
    @BindView(R2.id.ll_read_aloud_key)
    LinearLayout llReadAloudKey;
    @BindView(R2.id.ll_click_all_next)
    LinearLayout llClickAllNext;
    @BindView(R2.id.reNavBarColor)
    TextView reNavBarColor;
    @BindView(R2.id.reNavBarColor_val)
    TextView reNavBarColorVal;
    @BindView(R2.id.llNavigationBarColor)
    LinearLayout llNavigationBarColor;
    @BindView(R2.id.sbImmersionStatusBar)
    ATESwitch sbImmersionStatusBar;
    @BindView(R2.id.llImmersionStatusBar)
