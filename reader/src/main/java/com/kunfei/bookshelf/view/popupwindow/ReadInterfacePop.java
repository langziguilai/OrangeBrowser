...
public class ReadInterfacePop extends FrameLayout {
    ...
    View vwBg;
    @BindView(R2.id.fl_text_Bold)
    TextView flTextBold;
    @BindView(R2.id.fl_text_font)
    TextView fl_text_font;
    @BindView(R2.id.civ_bg_white)
    CircleImageView civBgWhite;
    @BindView(R2.id.civ_bg_yellow)
    CircleImageView civBgYellow;
    @BindView(R2.id.civ_bg_green)
    CircleImageView civBgGreen;
    @BindView(R2.id.civ_bg_black)
    CircleImageView civBgBlack;
    @BindView(R2.id.civ_bg_blue)
    ...
    @BindView(R2.id.tv4)
    TextView tv4;
    @BindView(R2.id.nbPaddingTop)
    NumberButton nbPaddingTop;
    @BindView(R2.id.nbPaddingBottom)
    NumberButton nbPaddingBottom;
    @BindView(R2.id.nbPaddingLeft)
    NumberButton nbPaddingLeft;
    @BindView(R2.id.nbPaddingRight)
    NumberButton nbPaddingRight;
    @BindView(R2.id.tvPageMode)
    TextView tvPageMode;
    @BindView(R2.id.nbTextSize)
    NumberButton nbTextSize;
    @BindView(R2.id.nbLineSize)
    NumberButton nbLineSize;
    @BindView(R2.id.nbParagraphSize)
    NumberButton nbParagraphSize;
    @BindView(R2.id.fl_indent)
    TextView tvIndent;
    @BindView(R2.id.nbTipPaddingTop)
    NumberButton nbTipPaddingTop;
    @BindView(R2.id.nbTipPaddingBottom)
    NumberButton nbTipPaddingBottom;
    @BindView(R2.id.nbTipPaddingLeft)
    NumberButton nbTipPaddingLeft;
    @BindView(R2.id.nbTipPaddingRight)
    NumberButton nbTipPaddingRight;
    @BindView(R2.id.nbLetterSpacing)
